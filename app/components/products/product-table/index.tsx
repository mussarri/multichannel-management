...
export function ProductTable({ products }: { products: any[] }) {
  ...
  return (
    ...
    >
      <div className=" bg-card border-b px-4 py-2 gap-3">
      ...
      <div className="box p-4">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-semibold pb-2">Tablo</h2>
          <button
            type="button"
            ...
            <thead className="bg-inherit">
              <tr className="">
                <th className="text-left p-2 border-b">
                  <label key={"Görsel"} className="flex items-center gap-1 ">
                    <input
                      type="checkbox"
                      checked={image}
                      ...
                      <td className="p-2">
                        {image && (
                          <Link href={`/dashboard/products/${product.id}`}>
                            <div className="h-[60px] rounded-md relative overflow-hidden">
