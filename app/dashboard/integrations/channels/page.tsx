...
export default function IntegrationsPage() {
  return (
    <div className="">
      ...
      >
        <Link
          href={"/dashboard/integrations/channels/trendyol"}
        ...
        <Link
          href={"/dashboard/integrations/channels/hepsiburada"}
          className="w-full rounded-lg overflow-hidden border shadow-sm flex flex-col max-w-[160px]"
          style={{ aspectRatio: 0.9 }}
        >
          <div
        ...
        <Link
          href={"/dashboard/integrations/channels/gittigidiyor"}
          className="w-full rounded-lg overflow-hidden border shadow-sm flex flex-col max-w-[160px]"
          style={{ aspectRatio: 0.9 }}
        >
        ...
        <Link
          href={"/dashboard/integrations/channels/akakce"}
          className="w-full rounded-lg overflow-hidden border shadow-sm flex flex-col max-w-[160px]"
          style={{ aspectRatio: 0.9 }}
        >
          <div
            ...
            style={{ aspectRatio: 12 / 10 }}
          >
            <Image src="/logo/akakce.jpeg" alt="" fill />
          </div>
          <div className="text-xs font-semibold w-full text-center p-2 flex items-center justify-center h-full">
            Akakce Ayarlari
          </div>
        ...
        <Link
          href={"/dashboard/integrations/channels/n11"}
          className="w-full rounded-lg overflow-hidden border shadow-sm flex flex-col max-w-[160px]"
          style={{ aspectRatio: 0.9 }}
        >
          <div
        ...
        <Link
          href={"/dashboard/integrations/channels/amazon"}
          className="w-full rounded-lg overflow-hidden border shadow-sm flex flex-col max-w-[160px]"
          style={{ aspectRatio: 0.9 }}
        >
          <div
