...
export default function ProductsPage() {
  ...
  return (
    <div className="space-y-4 pb-10">
      ...
      <div className="box w-full flex flex-col gap-2 relative items-start overflow-x-auto">
        <h2 className="font-semibold">Trendyol Kategori Seçin</h2>
            ...
            <table className="w-full">
              <thead>
                <tr className="text-sm font-medium text-left">
                  <th>Sopyo Seçenek Adı</th>
                  <th>Trendyol Seçenek Adı</th>
                  <th>İşlemler</th>
                </tr>
              </thead>
              <tbody>
                {smarthubProductAttributes.map((item, index) => (
                  <tr key={index} className="text-sm">
                    ...
                    <td className="min-w-[200px] flex gap-2 itesm-center">
                      ...
                      {smarthubProductAttributes.find(
                        ...
                        <>
                          <Link
                            href={
                              "/dashboard/trendyolVariantSyncSpec/" +
